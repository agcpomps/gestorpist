...
from .models import Alvara, Empresa, Especialidade, Documento

@admin.register(Especialidade)
class EspecialidadeEmpresa(admin.ModelAdmin):
    list_display = ['nome']
    search_fields = ['nome']
...
class EmpresaAdmin(admin.ModelAdmin):
    list_display = ["nome", "telefone", "email", "provincia", "municipio", "especialidade"]
